        ...
        if (orderedFaces[i].type > 0) {
           ...
           /*
                    ...
                    */
                    ...
                    if (orderedFaces[i].d.distance > 8) {
...
function Main() {
    ...
    renderCanvas = createCanvas(CanvasWidth, CanvasHeight);
    renderContext = renderCanvas.getContext("2d");
    renderImageData = renderContext.createImageData(CanvasWidth, CanvasHeight);
            ...
            */
            ...
            for (var fuckme = MinX; fuckme <= MaxX ; fuckme++) {
                ...
                if (fuckme < 0) {
                    ...
                    setPixel(renderImageData, fuckme, y, tempcolor);
                }
