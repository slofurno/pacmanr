...
function Main() {
    ...
    */
    ...
    CanvasWidth = 400; //context.canvas.clientWidth;
    CanvasHeight = 300; //context.canvas.clientHeight;
    ...
    targetContext = document.getElementById('myCanvas').getContext('2d');
