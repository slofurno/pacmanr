...
levelData.prototype.draw = function () {
    ...
    for (var i = 0; i < this.wallFaces.length; i++) {
        ...
        orderedFaces[i] = {
            a: this.wallFaces[i].a, b: this.wallFaces[i].b, c: this.wallFaces[i].c, d: angletocamera, color: { r: this.wallFaces[i].color.r, b: this.wallFaces[i].color.b, g: this.wallFaces[i].color.g }
        };
...
function Main() {
    ...
    newLevel.addBlock(8, 0, 28);
    newLevel.addBlock(8, 1, 28);
    newLevel.addBlock(8, 2, 28);
    newLevel.addBlock(8, 0, 29);
    newLevel.addBlock(8, 1, 29);
    newLevel.addBlock(8, 2, 29);
    newLevel.addBlock(8, 0, 30);
    newLevel.addBlock(8, 1, 30);
    newLevel.addBlock(8, 2, 30);
    newLevel.addBlock(8, 0, 31);
    newLevel.addBlock(8, 1, 31);
    newLevel.addBlock(8, 2, 31);
    newLevel.addBlock(8, 0, 32);
    newLevel.addBlock(8, 1, 32);
    newLevel.addBlock(8, 2, 32);
    newLevel.addBlock(8, 0, 33);
    newLevel.addBlock(8, 1, 33);
    newLevel.addBlock(8, 2, 33);
    newLevel.addBlock(8, 0, 34);
    newLevel.addBlock(8, 1, 34);
    newLevel.addBlock(8, 2, 34);
    newLevel.addBlock(8, 0, 35);
    newLevel.addBlock(8, 1, 35);
    newLevel.addBlock(8, 2, 35);
    newLevel.addBlock(8, 0, 36);
    newLevel.addBlock(8, 1, 36);
    newLevel.addBlock(8, 2, 36);
    newLevel.addBlock(8, 0, 37);
    newLevel.addBlock(8, 1, 37);
    newLevel.addBlock(8, 2, 37);
    newLevel.addBlock(8, 0, 38);
    newLevel.addBlock(8, 1, 38);
    newLevel.addBlock(8, 2, 38);
    newLevel.addBlock(10, 0, 28);
    newLevel.addBlock(10, 1, 28);
    newLevel.addBlock(10, 2, 28);
    newLevel.addBlock(10, 0, 29);
    newLevel.addBlock(10, 1, 29);
    newLevel.addBlock(10, 2, 29);
    newLevel.addBlock(10, 0, 30);
    newLevel.addBlock(10, 1, 30);
    newLevel.addBlock(10, 2, 30);
    newLevel.addBlock(10, 0, 31);
    newLevel.addBlock(10, 1, 31);
    newLevel.addBlock(10, 2, 31);
    newLevel.addBlock(10, 0, 32);
    newLevel.addBlock(10, 1, 32);
    newLevel.addBlock(10, 2, 32);
    newLevel.addBlock(10, 0, 34);
    newLevel.addBlock(10, 1, 34);
    newLevel.addBlock(10, 2, 34);
    newLevel.addBlock(10, 0, 35);
    newLevel.addBlock(10, 1, 35);
    newLevel.addBlock(10, 2, 35);
    newLevel.addBlock(10, 0, 36);
    newLevel.addBlock(10, 1, 36);
    newLevel.addBlock(10, 2, 36);
    newLevel.addBlock(10, 0, 37);
    newLevel.addBlock(10, 1, 37);
    newLevel.addBlock(10, 2, 37);
    newLevel.addBlock(10, 0, 38);
    newLevel.addBlock(10, 1, 38);
    newLevel.addBlock(10, 2, 38);
    newLevel.addBlock(11, 0, 32);
    newLevel.addBlock(11, 1, 32);
    newLevel.addBlock(11, 2, 32);
    newLevel.addBlock(11, 0, 34);
    newLevel.addBlock(11, 1, 34);
    newLevel.addBlock(11, 2, 34);
    newLevel.addBlock(12, 0, 32);
    newLevel.addBlock(12, 1, 32);
    newLevel.addBlock(12, 2, 32);
    newLevel.addBlock(12, 0, 34);
    newLevel.addBlock(12, 1, 34);
    newLevel.addBlock(12, 2, 34);
    newLevel.addBlock(13, 0, 32);
    newLevel.addBlock(13, 1, 32);
    newLevel.addBlock(13, 2, 32);
    newLevel.addBlock(13, 0, 34);
    newLevel.addBlock(13, 1, 34);
    newLevel.addBlock(13, 2, 34);
